...
function App() {
  ...
  const addTask = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post("https://todo-app-mern-plum.vercel.app/api/item", { item: taskText })
  ...
  useEffect(() => {
    const getTasksList = async () => {
      try {
        const res = await axios.get("https://todo-app-mern-plum.vercel.app/api/items")
  ...
  const updateTask = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.put(`https://todo-app-mern-plum.vercel.app/api/item/${isUpdating}`, { item: updateTaskText })
  ...
  const deleteTask = async (id) => {
    try {
      const res = await axios.delete(`https://todo-app-mern-plum.vercel.app/api/item/${id}`)
  ...
  const changeStatusToTodo = async (item) => {
    try {
      const res = await axios.put(`https://todo-app-mern-plum.vercel.app/api/item/todo/${item._id}`, { status: "todo" })
      setCount(count + 1);
    } catch (err) {
      console.log(err)
    }
  ...
  const changeStatusToInProgress = async (item) => {
    try {
      const res = await axios.put(`https://todo-app-mern-plum.vercel.app/api/item/in-progress/${item._id}`, { status: "in-progress" })
      setCount(count + 1);
    } catch (err) {
      console.log(err)
    }
  ...
  const changeStatusToDone = async (item) => {
    try {
      const res = await axios.put(`https://todo-app-mern-plum.vercel.app/api/item/done/${item._id}`, { status: "done" })
      setCount(count + 1);
    } catch (err) {
      console.log(err)
    }
